This would be posted on YouTube and possibly on TV someday, and could also be the basis for a banner ad to place on [friends'](/FriendsOfSolSeed) websites.  Also, if it turns out that I'm trying to cram too much stuff into those 30 seconds (as usual), it could be lengthened to a full minute.
...
- Visuals:
  ...
  - Wipe to a futuristic green city with high-speed rail line in the foreground, surrounded by wild [chaparral](http://en.wiktionary.org/wiki/chaparral) with a few orange groves, and passing through a short tunnel to keep it from splitting the landscape
...
#### Part 2
- Narration or text: "Now imagine that world as the [seed](/seed) of something far greater."
- Visuals: Continuous pullback
  - Start with a view of [Earth](/Earth) from space as it transforms into a symbolic glowing green orb
  ...
  - [Sol](/Sol) comes into view and moves toward the center of the screen
  ...
  - The remaining shoots extend beyond the solar system, while the three green orbs merging with [Sol](/Sol) to become a green flare
...
#### Part 3
- Narration or text: "The [SolSeed Movement](/SolSeed_Movement) is taking the first steps toward making this vision real. Join us at SolSeed.org."
- Visual: [SolSeed logo](/Media:Ben_SolSeed_Emblem_Simplified.jpg)
