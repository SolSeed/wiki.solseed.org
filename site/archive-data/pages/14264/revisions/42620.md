...
- Ben ... find photos to add to the newsletter ... by next call</s> (still needed one for [YayLifeTri](/YayLifeTri) though)
...
- Should we pledge $1000 so they will make a song for SolSeed?
  ...
  - Include Ben's [suggestion for some of the lyrics](/SolSeedThemeSong)?
