...
### Summary of the March 10, 2009 [SolSeedCall](/SolSeedCall)
[Mark](/Mark), [Ben](/Ben), [Brenna](/Brenna), [Shelley](/Shelley), and [Brandon](/Brandon) were all on the March 10 call.  After [OpeningWords](/OpeningWords) and checking in with each other about how we are doing, we spent the majority of the call discussing [WaterProjectOne](/WaterProjectOne), [RecruitingAndWelcoming](/RecruitingAndWelcoming), and [Sol2009](/Sol2009).  Before the [March 17, 2009](/March_17,_2009) call we will do the following:
- [Ben](/Ben) will set up our [WaterProjectOne](/WaterProjectOne) fund raising site;
- [Shelley](/Shelley) will share the email about [WaterProjectOne](/WaterProjectOne) with the [SolSeedContactList](/SolSeedContactList);
- [Brenna](/Brenna) will reserve the community center at Oceanside for July 3-6 for [Sol2009](/Sol2009) (or collect the available dates during July and August if it is not available July 3-6);
- [Mark](/Mark) will find [ClosingWords](/ClosingWords) for the next call;
- [Brandon](/Brandon) will send out a short summary of the call to the [SolSeedContactList](/SolSeedContactList).
...
- Brandon: send call summary, check on table-getting for [WorldCon](/WorldCon)
