...
#### WWWs from last time
- [Shelley](/Shelley) ... email to Ben about February 6 (ben to forward) ... tonight
  - [Ben](/Ben) was uncomfortable sending out the message due to its religious connotations
- [Shelley](/Shelley) ... service program outline ... by next meeting (Sunday)
  - Done, except no theme yet
- [Ben](/Ben) ... booth and table applications sent ... by next meeting (Sunday)
  - Set email re table, haven't heard back yet
- [Brandon](/Brandon) ... invite [Mark](/Mark) and [Ted](/Ted) to NorWesCon ... by next meeting (Sunday)
  - Only Mark so far
- [Ben](/Ben) ... email triad, ask Shelley for phone #s if they don't reply
...
- Theme based on one of the values
  ...
  - Others for later
    ...
    - Presence / mindfulness / being in the now, Nurture body, mind and spirit ([SelfLove](/SelfLove))
    - We ALL are precious SolSeed (openness/welcoming differences) (community) ([Empathy](/Empathy))
    - Acting Upstream ([Wisdom](/Wisdom))
...
- Google searches for "space" and "wiki" are about 70,000/month
  ...
  - [Shelley](/Shelley): but do we really want another project?
- To make this useful for bringing in searchers, we can't just forward it to solseed.org
  ...
  - Sponsorships ... where would we get them?
    - Not the first time, other than [SolSeedMovement](/SolSeedMovement) itself

#### NorWesCon
- Deadline for getting a [dealer booth](http://norwescon.org/dealers.htm) was last month, and we would need a Washington State business license
- [Brandon](/Brandon) is wondering if the work to do sci-fi conventions is worth it
- Just get a [table](http://norwescon.org/lobbytables.htm) ... how many of our previous ideas can we still use?
