...
- Eric ... post thoughts on the [Religious Method](/Religious_Method) from the email I sent ... by next call</s>
...
- Read through values, beliefs etc of the [OnePagePlan](/OnePagePlan)
...
- **All [life](/life) is precious.**  This is the root of our value system.  Respecting and cherishing life is the reason for everything we do.
  ...
  - **We ALL are precious [SolSeed](/SolSeed).**  SolSeed is defined as "the body of all life on Earth," encompassing every human culture and belief system as well as all other species.  This connects particularly to the "Openness/welcoming differences" practice below. (Is this one redundant?)
...
- Become a player in the space industry
  - Does this go against the value of "acting upstream"? ... not if we go the open-source ["space hacking"](http://spacehack.org/) route
